...
public class CreateRecord extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.add_btn:
                ...
                myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if ((!dataSnapshot.child(username).exists())
                            ...
                            Toast.makeText(CreateRecord.this, "User added", Toast.LENGTH_SHORT).show();
                        }
                        else if((username.isEmpty()) ||(pass.isEmpty())){
                            Toast.makeText(CreateRecord.this, "Please fill out all fields", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            Toast.makeText(CreateRecord.this, "User already exists", Toast.LENGTH_SHORT).show();
                        }
                    }
                ...
                break;
            case R.id.back_btn:
                Intent back = new Intent(CreateRecord.this, AdminPage.class);
                startActivity(back);
                break;
        }
    }
